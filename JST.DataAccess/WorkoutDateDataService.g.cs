...
namespace JST.DataAccess
{
    ...
    {
        void Insert(JstDataContext dataContext, Domain.WorkoutDate workoutDate);

        void Update(JstDataContext dataContext, Domain.WorkoutDate workoutDate);
    ...
    {
        public virtual void Insert(JstDataContext dataContext, Domain.WorkoutDate workoutDate)
        {
        ...
        public virtual void Update(JstDataContext dataContext, Domain.WorkoutDate workoutDate)
        {
